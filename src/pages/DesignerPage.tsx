          ...
          <section className="max-w-3xl mx-auto px-4 py-10 space-y-8">
            <div>
              ...
              <div className="space-y-3 text-sm text-[hsl(var(--muted-foreground))] leading-relaxed">
                <p>
                  Конструктор дизайна участка использует нейросеть для генерации изображений: вы загружаете обычное фото своего участка или дома, а искусственный интеллект перерисовывает его в выбранном ландшафтном стиле — с сохранением построек, но с новым озеленением, дорожками, малыми архитектурными формами и декором.
                </p>
                <p>
                  Это удобная альтернатива дорогому ландшафтному проекту на этапе, когда вы только выбираете направление — прежде чем нанимать дизайнера или закупать растения и материалы, можно за пару минут увидеть, как будет смотреться участок в английском, японском, скандинавском стиле или в духе русской усадьбы.
                </p>
                <p>
                  Сервис пригодится владельцам частных домов и дач, которые благоустраивают территорию своими руками, а также тем, кто строит каркасный дом и планирует одновременно с этим продумать оформление прилегающего участка.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  {
                    q: "Какое фото подходит для визуализации?",
                    a: "Лучше всего подходит дневное фото участка без сильных теней, снятое в полный рост — так, чтобы был виден дом, забор или основные ориентиры территории. Подходят JPG и PNG размером до 10 МБ.",
                  },
                  {
                    q: "Сколько стоит и сколько ждать результат?",
                    a: `Один вариант дизайна стоит ${PRICE_PER} ₽. Можно выбрать сразу до 3 стилей и сравнить их между собой. Генерация занимает около 2 минут на каждый стиль.`,
                  },
                  {
                    q: "Можно ли описать свой стиль вместо готовых вариантов?",
                    a: "Да, в шаге выбора стиля есть пункт «Свой вариант» — опишите словами, что хотите увидеть (растения, покрытие дорожек, зоны отдыха), и ИИ учтёт эти пожелания при генерации.",
                  },
                  {
                    q: "Заменяет ли это работу ландшафтного дизайнера?",
                    a: "Нет, визуализация даёт только общее представление о стиле и настроении участка для вдохновения. Для точного проекта с посадочным чертежом и сметой материалов всё равно нужен профессиональный ландшафтный дизайнер.",
                  },
                ].map((item) => (
